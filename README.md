...
누구나 언어의 장벽 없이 영상을 제작하고 공유할 수 있도록 돕는 AI SaaS 서비스입니다.

---

## 📊 정확도 평가 자동화 (`scripts/evaluate.ts`)

- 데이터의 **20%를 테스트셋**으로 사용  
